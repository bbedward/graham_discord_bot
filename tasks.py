...
from bot import DONATION_ADDRESS
...
def send_transaction(self, tx):
    try:
        ...
        if 'block' in wallet_output:
            ...
            mark_tx_processed.subtask(source_address, txid, uid, to_address, amount)
            return
        else:
            ...
            if attempts >= MAX_TX_RETRIES:
                ...
                mark_tx_processed.subtask(source_address, 'invalid', uid, to_address, amount)
            else:
